...
function AddLecture() {
  ...
  return (
    <HomeLayout>
      <div className="h-[90vh] text-white flex flex-col items-center justify-center gap-10 m-16">
           ...
           <form
            ...
            >
              ...
              {userInput.videoSrc ? (
                ...
                <div className="h-48 border flex flex-center items-center justify-center cursor-pointer">
