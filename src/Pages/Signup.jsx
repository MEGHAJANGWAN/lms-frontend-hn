        ...
        <div className="flex items-center justify-center h-[100vh]">
            <form noValidate onSubmit={createNewAccount} className="flex flex-col justify-center gap-3 rounded-lg p-4 text-white w-96 shadow-[0_0_10px_black]"> 
               ...
               <div className='flex flex-col gap-1'>
                ...
                <button type='submit' className='bg-yellow-600 p-2 hover:bg-yellow-500 transition-all ease-in-out duration-300 rounded-sm font-semibold text-lg cursor-pointer mt-2'>
                    Create account
                </button>
