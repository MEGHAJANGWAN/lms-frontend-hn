import aboutMainImage from "../assets/Images/aboutMainImages.png";
    ...
    return(
        <HomeLayout >
           <div className="pl-20 pt-20 flex flex-col text-white">
              ...
              <div className="w-1/2">
                <img id="test1" style={{filter: "drop-shadow(0px 10px 10px rgb(0,0,0));"}} className="drop-shadow-2xl" src={aboutMainImage} alt="about main image" />
               </div>
             </div>
